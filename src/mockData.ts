...
export const INITIAL_CONFIG: AppConfig = {
    ...
    packages: [
      { id: 'pkg1', name: 'CBA Program', services: ['CBA'], weight: 1.0 },
      { id: 'pkg2', name: 'Digital Banking Program', services: ['CBA', 'USSD', 'Transfers', 'Mobile', 'Cards', 'APIs'], weight: 1.5 },
      { id: 'pkg3', name: 'Digital Uplift Program', services: ['USSD', 'Transfers', 'Mobile', 'Cards', 'APIs'], weight: 1.2 },
      { id: 'pkg4', name: 'Retail Banking Program', services: ['CBA', 'USSD', 'Transfers', 'Mobile', 'Cards', 'APIs', 'CDR', 'CAS', 'Collections and Recovery'], weight: 2.0 },
      { id: 'pkg5', name: 'Distributed Banking Program', services: ['CBA', 'USSD', 'Transfers', 'Mobile', 'Cards', 'APIs', 'Agency', 'Merchant Banking'], weight: 2.2 },
      { id: 'pkg6', name: 'Digital Transformation Program', services: ['CBA', 'USSD', 'Transfers', 'Mobile', 'Cards', 'APIs', 'Agency', 'Merchant Banking', 'CDR', 'CAS', 'Collections and Recovery'], weight: 3.0 },
      { id: 'pkg7', name: 'Lending as a Service', services: ['CDR', 'CAS', 'Collections and Recovery'], weight: 1.0 },
      { id: 'pkg8', name: 'Cluster Program', services: ['Agency', 'Merchant Banking'], weight: 1.0 },
      { id: 'pkg9', name: 'Core & Card Program', services: ['CBA', 'Cards'], weight: 1.2 },
      { id: 'pkg10', name: 'Internal Initiative', services: [], weight: 1.0 },
    ],
    productLines: [
